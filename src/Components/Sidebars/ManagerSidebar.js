...
export default function ManagerSidebar(){
    return (
        <div style={{ 
            width: '250px', 
            height: '100vh', 
            backgroundColor: '#97a97c',  // Lighter black (dark grey)
            padding: '20px', 
            boxShadow: '2px 0 6px rgba(0, 0, 0, 0.2)',  // Subtle shadow for depth
        }}>
          <Nav className="flex-column">
            <Nav.Link href="/ManagerDashboard" style={{ color: 'black', marginBottom: '10px' }}>
                <House style={{ marginRight: '10px' }} /> Manager Dashboard
            </Nav.Link>
            <Nav.Link href="/ManagerProfile" style={{ color: 'black', marginBottom: '10px' }}>
                <Person style={{ marginRight: '10px' }} /> Manager Profile
            </Nav.Link>
            <Nav.Link href="/ManagerUsersDashboard" style={{ color: 'black', marginBottom: '10px' }}>
