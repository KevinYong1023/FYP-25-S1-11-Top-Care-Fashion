            ...
            fetch(`/api/products/user/${email}`)
                ...
                .then((data) => {
                    if (Array.isArray(data)) {
                        ...
                        setMessage("Failed to load products. Invalid data format.");
    ...
    return (
        <>
            ...
            <Container className="mt-4">
                ...
                {products.length > 0 && ( // Render table only if products array is not empty
                ...
                {products.length > 0 && ( // Render pagination only if products array is not empty
