...
const Home = () => {  
    // Sample product data  
    const products = [  
        { name: 'Stylish Jacket', brand: 'Brand A', price: '$49.99' },  
        { name: 'Casual Sneakers', brand: 'Brand B', price: '$39.99' },  
        { name: 'Elegant Dress', brand: 'Brand C', price: '$59.99' },  
        { name: 'Sporty Watch', brand: 'Brand D', price: '$99.99' },  
        { name: 'Classic Sunglasses', brand: 'Brand E', price: '$29.99' },  
        { name: 'Trendy Backpack', brand: 'Brand F', price: '$34.99' },  
    ];  
                ...
                <div className="product-grid">  
                    {products.map((product, index) => (  
                        <div className="product" key={index}>  
                            <div className="product-image"></div> {/* Placeholder for product image */}  
